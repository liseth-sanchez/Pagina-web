...
menuInicial.addEventListener('click', ()=>{ //al elemento menuIncial se le agrega un evento .addEventListener de tipo click menuFinal.classList.toggle("spread") }) //al menu -le seleccione las clases -y que coloque y le quite la clase spread
